...
#             short_description = full_product_details.get('shortDescription', title)
...
def streamlit_analysis(streamlit_result):
    """
    {
            "results": [
                {"title": "Cat 1", "imageUrl": "https://i.ebayimg.com/images/g/7cIAAOSwFHZnMA8N/s-l225.jpg", "description": "description text"},
...
# Load your knowledge base
    ...
    matcher.build_index()
    image_url = streamlit_result['imageUrl']
    matches =  matcher.match(image_url=image_url, threshold=.5, top_k=3)
    return matches